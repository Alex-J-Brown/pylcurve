...
def run_mcmc_save(sampler, startPos, nSteps, rState, file, progress=True, smoothing=0.7, start_step=0, **kwargs):
    """
    ...
    iStep = 0
    if progress:
        bar = tqdm(total=nSteps+start_step, smoothing=smoothing)
